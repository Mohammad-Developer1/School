...
public class RunnerExam {
    ...
    public static void Exam() {
        ...
        System.out.println("3: Show All Exam");
...
//    }
    public static void addExam() {
        ...
        try {
            ApplicationContext.getExamService().addExam(new Exam( name, LocalDate.of(year,month,day), LocalTime.of(hour,minute),ApplicationContext.getCourseService().getCourseByTitle(name).get().getCourseId()));
